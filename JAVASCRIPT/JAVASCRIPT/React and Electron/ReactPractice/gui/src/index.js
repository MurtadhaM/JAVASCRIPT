...
const contract = require("@truffle/contract")(require("./abi.json"));
  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      const contractInstance = await contract.at(
        "0x09fE45A62502E7a0b226a99f18043F3eC32F78E8"
      );
      console.log({ contractInstance });
      console.log({
        info: contractInstance.userInfo(
          "0xF4d46fB6dF82af20ED421bFF828fD8FD199D234c"
        )
      });
    })();
  }, [library]);
